...
SIGNAL \uartpiso|rgstr_r\ : std_logic_vector(8 DOWNTO 0);
SIGNAL \txfsm|txstates\ : std_logic_vector(31 DOWNTO 0);
SIGNAL \txfsm|ALT_INV_busy~0_combout\ : std_logic;
SIGNAL \uartpiso|ALT_INV_rgstr_r\ : std_logic_vector(8 DOWNTO 8);
...
\uartpiso|ALT_INV_rgstr_r\(8) <= NOT \uartpiso|rgstr_r\(8);
...
PORT MAP (
	...
	datac => \rxtimer|Equal0~0_combout\,
	datad => \rxtimer|Equal0~1_combout\,
...
-- Equation(s):
-- \rxbitcounter|counter[3]~0_combout\ = (\txfsm|txstates\(2) & (!\txfsm|txstates\(0) & (\rxbitcounter|Equal0~0_combout\ & !\txfsm|txstates\(1)))) # (!\txfsm|txstates\(2) & (\txfsm|txstates\(0) & ((\txfsm|txstates\(1)))))
...
-- Equation(s):
-- \rxbitcounter|Add0~0_combout\ = \rxbitcounter|counter\(3) $ (((\rxbitcounter|counter\(2) & (\rxbitcounter|counter\(0) & \rxbitcounter|counter\(1)))))
...
-- Equation(s):
-- \rxbitcounter|Equal0~0_combout\ = (!\rxbitcounter|counter\(0) & (!\rxbitcounter|counter\(2) & (\rxbitcounter|counter\(1) & \rxbitcounter|counter\(3))))
...
PORT MAP (
	...
	datac => \rxbitcounter|counter\(1),
	datad => \rxbitcounter|counter\(3),
	combout => \rxbitcounter|Equal0~0_combout\);

-- Location: LCCOMB_X114_Y15_N20
\txfsm|reset_bit_counter~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \txfsm|reset_bit_counter~0_combout\ = (\txfsm|txstates\(0) & (!\txfsm|txstates\(2) & \txfsm|txstates\(1))) # (!\txfsm|txstates\(0) & (\txfsm|txstates\(2) & !\txfsm|txstates\(1)))
...
-- Equation(s):
-- \txfsm|txstates[2]~1_combout\ = (\txshot|state.Shot_State~q\ & (!\txfsm|txstates\(1) & (\txfsm|txstates\(2) & !\txfsm|txstates\(0))))
...
-- Equation(s):
-- \uartparitygen|WideXor0~1_combout\ = \data[6]~input_o\ $ (\data[4]~input_o\ $ (\data[7]~input_o\ $ (\data[5]~input_o\)))
...
-- Equation(s):
-- \uartparitygen|WideXor0~0_combout\ = \data[0]~input_o\ $ (\data[3]~input_o\ $ (\data[2]~input_o\ $ (\data[1]~input_o\)))
...
-- Equation(s):
-- \comb~0_combout\ = (\txfsm|txstates\(0) & !\txfsm|txstates\(2))
...
-- Equation(s):
-- \uartpiso|rgstr_r~8_combout\ = (\comb~0_combout\ & (\uartpiso|rgstr_r\(8) & (\txfsm|txstates\(1)))) # (!\comb~0_combout\ & (((\uartpiso|rgstr_r\(0)))))
...
-- Equation(s):
-- \txfsm|Equal0~0_combout\ = (\txfsm|txstates\(0) & (!\txfsm|txstates\(2) & !\txfsm|txstates\(1)))
...
-- Equation(s):
-- \uartpiso|rgstr_r~7_combout\ = (\txfsm|Equal0~0_combout\ & (\uartparitygen|WideXor0~1_combout\ $ ((\uartparitygen|WideXor0~0_combout\)))) # (!\txfsm|Equal0~0_combout\ & (((\uartpiso|rgstr_r\(0)))))
...
PORT MAP (
	...
	datab => \uartparitygen|WideXor0~0_combout\,
	datac => \uartpiso|rgstr_r\(0),
...
-- Equation(s):
-- \uartpiso|rgstr_r~6_combout\ = (\txfsm|txstates\(1) & (((\uartpiso|rgstr_r\(1))))) # (!\txfsm|txstates\(1) & ((\comb~0_combout\ & (!\data[0]~input_o\)) # (!\comb~0_combout\ & ((\uartpiso|rgstr_r\(1))))))
...
-- Equation(s):
-- \uartpiso|rgstr_r~5_combout\ = (\txfsm|txstates\(1) & (((\uartpiso|rgstr_r\(2))))) # (!\txfsm|txstates\(1) & ((\comb~0_combout\ & (!\data[1]~input_o\)) # (!\comb~0_combout\ & ((\uartpiso|rgstr_r\(2))))))
...
-- Equation(s):
-- \uartpiso|rgstr_r~4_combout\ = (\txfsm|txstates\(1) & (\uartpiso|rgstr_r\(3))) # (!\txfsm|txstates\(1) & ((\comb~0_combout\ & ((!\data[2]~input_o\))) # (!\comb~0_combout\ & (\uartpiso|rgstr_r\(3)))))
...
-- Equation(s):
-- \uartpiso|rgstr_r~3_combout\ = (\txfsm|txstates\(1) & (((\uartpiso|rgstr_r\(4))))) # (!\txfsm|txstates\(1) & ((\comb~0_combout\ & (!\data[3]~input_o\)) # (!\comb~0_combout\ & ((\uartpiso|rgstr_r\(4))))))
...
-- Equation(s):
-- \uartpiso|rgstr_r~2_combout\ = (\txfsm|txstates\(1) & (\uartpiso|rgstr_r\(5))) # (!\txfsm|txstates\(1) & ((\comb~0_combout\ & ((!\data[4]~input_o\))) # (!\comb~0_combout\ & (\uartpiso|rgstr_r\(5)))))
...
-- Equation(s):
-- \uartpiso|rgstr_r~1_combout\ = (\txfsm|txstates\(1) & (((\uartpiso|rgstr_r\(6))))) # (!\txfsm|txstates\(1) & ((\comb~0_combout\ & (!\data[5]~input_o\)) # (!\comb~0_combout\ & ((\uartpiso|rgstr_r\(6))))))
...
-- Equation(s):
-- \uartpiso|rgstr_r~0_combout\ = (\txfsm|txstates\(1) & (((\uartpiso|rgstr_r\(7))))) # (!\txfsm|txstates\(1) & ((\comb~0_combout\ & (!\data[6]~input_o\)) # (!\comb~0_combout\ & ((\uartpiso|rgstr_r\(7))))))
...
-- Equation(s):
-- \txfsm|busy~0_combout\ = (!\txfsm|txstates\(0) & !\txfsm|txstates\(1))
