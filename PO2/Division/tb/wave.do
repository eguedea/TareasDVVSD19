...
add wave -noupdate -radix unsigned /Division_Top_TB/clk
add wave -noupdate -radix unsigned /Division_Top_TB/rst
add wave -noupdate -radix unsigned /Division_Top_TB/start
add wave -noupdate -radix unsigned /Division_Top_TB/Dividendo
add wave -noupdate -radix unsigned /Division_Top_TB/Divisor
add wave -noupdate -radix unsigned /Division_Top_TB/ready
add wave -noupdate -radix unsigned /Division_Top_TB/Residuo
add wave -noupdate -radix unsigned /Division_Top_TB/Cosiente
...
WaveRestoreCursors {{Cursor 1} {16814 ps} 0}
...
update
WaveRestoreZoom {7293 ps} {39293 ps}
